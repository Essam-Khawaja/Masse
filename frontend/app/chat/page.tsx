...
export default function ChatPage() {
  ...
  return (
    <div className="bg-black text-white min-h-screen p-6 font-pixel">
      <h1 className="text-2xl mb-4">AI Dungeon Master Chat</h1>

      <section className="nes-container with-title is-dark p-4 max-h-[75vh] flex flex-col">
